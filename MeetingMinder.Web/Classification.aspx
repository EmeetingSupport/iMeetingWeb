<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="Classification.aspx.cs" Inherits="MeetingMinder.Web.Classification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <script type="text/javascript">
    ...
    <article class="content-box minimizer">
			<header>			
				<h2>&nbsp;<%--Master Classification--%></h2>			
			</header>
			<section>              
				<div >
                <fieldset>
							<legend><font color="#054a7f"><b>  Classification</b></font></legend>
                            <dl>
...
<h2 class="icon users">Master Classification</h2>
		...
		<div class="dataTables_wrapper">
                                  ...
                                  <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sr. No.">
                                     ...
                                     <asp:TemplateField HeaderText="Agenda" SortExpression="AgendaName">
                                        <ItemTemplate>
                                        <asp:Label style="text-align:justify" Width="600px"  ID="lblAgenda" runat="server" Text='<%# Eval("AgendaName") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                     ...
                     <div ID="divdetails" runat="server" style="margin-bottom:15px">
                       ...
                       <dt>
                                ...
                                <dd>
                                    <asp:TextBox  ID="txtClassification" runat="server" MaxLength="149" Width="400px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvUser" runat="server" 
                                        class="invalid-side-note" ControlToValidate="txtClassification" Display="Dynamic" 
