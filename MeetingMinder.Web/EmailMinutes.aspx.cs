...
{
    public partial class EmailMinutes : System.Web.UI.Page
    {
        /// <summary>
        /// page load event
        /// </summary>
                        ...
                        if (objAgentList.Count > 0)
                        {
                            ...
                            if (agendaName.Count() > 0)
                            {
                                ...
                                for (int i = 0; i <= agendaName.Count() - 1; i++)
                                {
                                    ...
                                    {
                                        strMenu.Append("<li id=" + agendaId + " class='group' ><h3>" + agendaName[i].AgendaName + "  </h3><span>" + agendaName[i].Minute + "</span>");
                                    }
                                    else
                                    {
                                        strMenu.Append("<li id=" + agendaId + " class='group' ><h3>" + agendaName[i].AgendaName + " </h3><span>" + agendaName[i].Minute + "</span>");
                                    ...
                                    if (subAgendaName.Count() > 0)
                                    {
                                        ...
                                        for (int j = 0; j <= subAgendaName.Count() - 1; j++)
                                        {
                                            ...
                                            {
                                                strMenu.Append("<li id=" + subAgendaName[j].AgendaId + "> " + (i + 1) + "." + (j + 1) + " " + subAgendaName[j].AgendaName + " <span>" + subAgendaName[j].Minute + "</span>");
                                            }
                                            else
                                            {
                                                strMenu.Append("<li id=" + subAgendaName[j].AgendaId + ">" + (i + 1) + "." + (j + 1) + " " + subAgendaName[j].AgendaName + "<span>" + subAgendaName[j].Minute + "</span> ");// + "</li>");
                                            }
                                            ...
                                            if (subSubAgendaName.Count() > 0)
                                            {
                                                ...
                                                for (int y = 0; y <= subSubAgendaName.Count() - 1; y++)
                                                {
                                                    ...
                                                    {
                                                        strMenu.Append("<li id=" + subSubAgendaName[y].AgendaId + ">" + subSubAgendaName[y].AgendaName + "<span>" + subSubAgendaName[y].Minute + "</span>");
                                                    }
                                                    else
                                                    {
                                                        strMenu.Append("<li id=" + subSubAgendaName[y].AgendaId + "> " + subSubAgendaName[y].AgendaName + "<span>" + subSubAgendaName[y].Minute + "</span>");
                            ...
                            txtEmail.Text = strMenu.ToString();
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string EmailSubject = "Draft Minutes";
