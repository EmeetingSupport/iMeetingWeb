...
{
    public partial class iPadNepalUserLogin : System.Web.UI.Page
    {
        /// <summary>
        /// page load event
        /// </summary>
                ...
                if (list != null)
                {
                    ...
                    if (list.IsEnabledOnIpad)
                    {
                        ...
                        if (mob == "91")
                        {
                            ...
                            //web logs
                            UserDataProvider.Instance.InsertWebLog(Convert.ToString(list.UserId), "OTP", "", "", Encryptor.EncryptString(response));
                        }
                        else
                        {
                            ...
                            //web logs
                            UserDataProvider.Instance.InsertWebLog(Convert.ToString(list.UserId), "Internation OTP", "", "", Encryptor.EncryptString(response));
                        ...
                        Response.Redirect("iPadNepalUserVerifyOtp.aspx");
