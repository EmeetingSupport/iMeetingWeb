<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AllUserMaster.aspx.cs" Inherits="MeetingMinder.Web.AllUserMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <article class="content-box minimizer">
			...
			<section>              
                ...
                <fieldset>
                            ...
                            <dl>
                               ...
                               <div class="add_remove" style="margin-bottom:15px;display:block;">
		...
		<h2 class="icon users">All User List</h2>
                                  ...
                                  <Columns>
                                   ...
                                   <%-- <asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Name" SortExpression="FirstName">
                                       ...
                                       <asp:TemplateField HeaderText="Department (Forum)">
                                        <ItemTemplate>
                                            <%# GetEntityId(Eval("EntityIds"), Eval("UserId"), Eval("EntityNames"))%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <%--<asp:BoundField DataField="Description"  HeaderText="Description"  />--%>
                                          <asp:TemplateField HeaderText="Access Rights" Visible="false">
...
<div  id ="divConfirmPassword" runat="server"   clientidmode="Static" class="infoPersonal">
 <dt>
                                ...
                                <dd>
                                   ...
                                   <br /> <%--<asp:CompareValidator class="invalid-side-note" ID="cfvConformPass" runat="server" ValidationGroup="a" Display="Static" SetFocusOnError="true" ControlToCompare="txtPassword"   ControlToValidate="txtConformPass" ErrorMessage="Password not match"></asp:CompareValidator>--%>
