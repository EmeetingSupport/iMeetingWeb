<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true"
    CodeBehind="CreateSubAgenda.aspx.cs" Inherits="MeetingMinder.Web.CreateSubAgenda" %>
 ...
 <script type="text/javascript">
     ...
     function ConfSub() {
         ...
         if (link === undefined) {
             ...
             if (file != '') {
                 if (confirm("Are you want to retain initial pdf ?")) {
    ...
    <article class="content-box minimizer">
			<header>			
				<h2>&nbsp;<%--Create Subagenda--%></h2>			
			</header>
			<section>              
				<div >
                 
						<fieldset>
							<legend><font color="#054a7f"><b>Create Subagenda </b></font></legend>
                             <dl>
                             <div >
            ...
            <asp:Button CssClass="btnSave" ID="btnBack"  runat="server" Text="Back" onclick="btnBack_Click"></asp:Button>
                                ...
                                <dd>
                             <asp:Label ID="lblAgenda" Font-Names="Rupee"   runat="server"></asp:Label>
                                </dd>
...
<h2 class="icon users">Sub Agenda</h2>
                                  ...
                                  <Columns>
                                     <asp:TemplateField HeaderText="Sr. No.">
                                        ...
                                        <ItemStyle  HorizontalAlign="Center" />
                                          ...
                                          <ItemTemplate>
                                             <asp:Label  style="text-align:justify;font-family:Rupee" Width="100px"  ID="lblSerial" runat="server" Text='<%# GetTitles(Eval("SerialTitle").ToString(), Eval("SerialNumber").ToString(), Eval("SerialText").ToString())  %>'></asp:Label>
                                          </ItemTemplate>
                                       </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Sub Agenda"  >
                                        <ItemTemplate>
                                          <asp:Label ID="lblTe"  Font-Names="Rupee"  runat="server" Text='<%#   Eval("HasChild") + ""+Eval("AgendaName").ToString().Replace(Environment.NewLine, "<BR/>") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     ...
                                     <asp:TemplateField HeaderText="Uploaded sub Agenda">
                                        <ItemTemplate>
     ...
     <asp:TemplateField HeaderText="Sub Sub Agenda">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkUploadAgenda" CommandArgument='<%# Eval("AgendaId") %>' CommandName="add"  Text="Add / View"  runat="server" />
                                     <%--   <a class="AddView" href="CreateSubSubAgenda.aspx?id=<%# Eval("AgendaId") %>" >Add / View</a>--%>
                              ...
                              <br /><br />
                                 ...
                                 <table width="75%">
                                   ...
                                   <asp:DropDownList  onchange="GetValue(this.value)" ID="ddlSerialNumber" ClientIDMode="Static" runat="server"  Width="250px" >
                                       ...
                                       <asp:ListItem Value="GM" Text="GM" ></asp:ListItem>--%>
                                           ...
                                           <br /><br />
                                           <asp:TextBox ID="txtOtherSerialNo"  Width="230px" runat="server" MaxLength="250" ClientIDMode="Static" style="display:none;"></asp:TextBox>
                                ...
                                ValidationGroup="a" InitialValue="0" ErrorMessage="Serial Number" Text="Invalid" ForeColor="Red"></asp:RequiredFieldValidator>
                                    ...
                                    Serial Text 
                                     ...
                                     <asp:DropDownList ID="ddlMaster" Width="250px"  Font-Names="Rupee"  onclick="GetAgenda()" runat="server"></asp:DropDownList>
                                     </td>
                                     </tr>
                                   <tr>
                                     <td style="width:95px;">
                                   ...
                                   Agenda Note
                                     ...
                                     <td  style="width:250px;" align="center">
                                    <asp:TextBox ID="txtAgendaNote" runat="server"  Width="50%"></asp:TextBox>                                   
                                    </td>
                                     </tr>
                                            <tr>
                                     <td style="width:95px;">
