<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="UserAttendance.aspx.cs" Inherits="MeetingMinder.Web.UserAttendance" %>
    ...
    <article class="content-box minimizer">
			...
			<section>  
				...
				<div >
						...
						<fieldset>
							<legend><font color="#054a7f"><b>Mark Attendance</b></font></legend>
                             <dl>
...
<%--                                            <asp:HiddenField ID="hdfAttendance" Value='<%# Eval("Attendance")%>' runat="server" />--%>
                                      ...
                                      <ItemTemplate>
                                          ...
                                          <asp:RadioButtonList SelectedIndex='<%#Convert.ToInt32(Eval("IsMaker"))%>'    CssClass="radio-att" ID="rbAttendance"   runat="server" RepeatDirection="Horizontal" >
...
<asp:Button ID="btnSubmit" runat="server" Visible="false"  Text="Submit" CssClass="btnSave" ValidationGroup="a" onclick="btnSubmit_Click"></asp:Button>
</div>
                                    </td>
                                     </tr>            
                                 </table>
