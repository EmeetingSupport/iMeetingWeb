...
namespace MeetingMinder.Web
{
    public partial class CreateSubSubAgenda : System.Web.UI.Page
    {
        ...
        private void BindSubAgenda()
        {
            try
            {
                if (Session["SubAgendaId"] != null) //(Request.QueryString["id"] != null)
                {
                    string AgendaId = Convert.ToString(Session["SubAgendaId"]); //Convert.ToString(Request.QueryString["id"]);
            ...
            try
            {
                ...
                if (isMaker)
                {
                    ...
                    if (hdnAgendaId != null && hdnAgendaId.Value != "")
                    {
                        ...
                        //web logs
                        UserDataProvider.Instance.InsertWebLog(Convert.ToString(objAgenda.UpdatedBy), "Sub Sub Agenda", "Success", Convert.ToString(objAgenda.AgendaId), "Agenda updated successfully :- " + encrypt + "");
                    ...
                    else
                    {
                        ...
                        if (objUser.IsEdit(Guid.Parse(ViewState["entityId"].ToString())))
                        {
                            ...
                            //web logs
                            UserDataProvider.Instance.InsertWebLog(Convert.ToString(objAgenda.CreatedBy), "Sub Sub Agenda", "Success", Convert.ToString(objAgenda.AgendaId), "Sub Agenda inserted successfully :- " + encrypt + "");

                        }
                        else
                        {
                            //web logs
                            UserDataProvider.Instance.InsertWebLog(Convert.ToString(objAgenda.CreatedBy), "Sub Sub Agenda", "Success", Convert.ToString(objAgenda.AgendaId), "Sorry access denied");
                ...
                {
                    //web logs
                    UserDataProvider.Instance.InsertWebLog(Convert.ToString(objAgenda.CreatedBy), "Sub Sub Agenda", "Success", Convert.ToString(objAgenda.AgendaId), "Sorry you are not maker");
                ...
                if (e.CommandName.ToLower().Equals("del"))
                {
                    ...
                    if (isMaker)
                    {
                        ...
                        if (objUser.isDelete(Guid.Parse(ViewState["entityId"].ToString())))
                        {
                            ...
                            //web logs
                            UserDataProvider.Instance.InsertWebLog(Convert.ToString(objAgenda.CreatedBy), "Sub Sub Agenda", "Success", Convert.ToString(Guid.Parse(ids[0])), "Agenda deleted successfully");
                        ...
                        {
                            //web logs
                            UserDataProvider.Instance.InsertWebLog(Convert.ToString(Guid.Parse(Session["UserId"].ToString())), "Sub Sub Agenda", "Failed", "", "Sorry access denied");
                    ...
                    {
                        //web logs
                        UserDataProvider.Instance.InsertWebLog(Convert.ToString(Guid.Parse(Session["UserId"].ToString())), "Sub Sub Agenda", "Failed", "", "Sorry you are not maker");
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (url != null && url != "")
                {
                    ...
                    // Response.Redirect(url + "&aid=" + Request.QueryString["id"].ToString());
                }
                else
                {
                    Response.Redirect("default.aspx");
